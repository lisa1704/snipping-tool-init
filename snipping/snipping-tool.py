# Snipping Tool with search on web feature
import sys
import numpy as np
import cv2
...
class MainWindow(QMainWindow):
    ...
    def initGUI(self):
        ...
        self.searchOpen.setStyleSheet("background-color:limegreen; color:#f7f7f7")
        ...
        self.copyPartNum.setStyleSheet("background-color:#1E90FF; color:#f7f7f7")
        self.copyPartNum.clicked.connect(self.snip_copy_clicked) 

        self.notificationBox = QGroupBox("Notification", self)
